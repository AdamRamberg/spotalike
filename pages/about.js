...
const About = () => (
  <>
    <Hero
      topRowProps={{
        leftIconProps: { iconKey: 'arrow-left', as: 'a', href: '/' },
        title: 'About',
        rightIconProps: { iconKey: 'more', as: 'button' },
      }}
      height="auto"
    >
    ...
    <TextWrapper>
      ...
      <Bread>
        ...
        turning to color postcards as a good way of promoting their products and
        services. This is simply because postcards don’t have to be opened. It
        won’t get lumped in with all the mail envelopes that people usually toss
        without opening.
      </Bread>
      <Bread>
        Business owners can’t afford to make mistakes when it to comes to their
        promotional materials. They spend a considerable amount of money in it
        so they would want them to bring greater sales and profits to their
        business. Thus, if the postcard reveals a glossy, professional
